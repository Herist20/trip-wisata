        ...
        setMessages([
          {
            id: 1,
            type: 'bot',
            text: 'Halo! 👋 Selamat datang di IndoTrip.',
            timestamp: new Date(),
          },
          {
            id: 2,
            type: 'bot',
            text: 'Saya adalah asisten virtual IndoTrip. Saya siap membantu Anda merencanakan liburan impian ke destinasi indah di Indonesia! ✈️',
            timestamp: new Date(),
          },
          {
            id: 3,
          ...
          <div className="bg-gradient-to-r from-primary to-secondary text-white p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-lg">IndoTrip Bot</h3>
